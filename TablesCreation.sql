...
insert into FLIGHT (DEPARTURE, DEPARTURETIME, ARRIVAL, ARRIVALTIME, TICKETPRICE, TICKETSTOTAL, TICKETSBOOKED,TICKETSSOLD, DELETED) values ('DME', '2015-09-01 00:00:00', 'RTM', '2015-09-11 11:00:00', 140.0, 37, 9, 27, 0);
insert into FLIGHT (DEPARTURE, DEPARTURETIME, ARRIVAL, ARRIVALTIME, TICKETPRICE, TICKETSTOTAL, TICKETSBOOKED,TICKETSSOLD, DELETED) values ('KBL', '2015-09-01 00:00:00', 'JFK', '2015-09-11 11:00:00', 140.0, 37, 9, 27, 0);
...
insert into PERSON (EMAIL, PASSWORDHASH, FIRSTNAME, LASTNAME, ROLE, ACTIVE) values ('default@user.com', 1216985755, 'default', 'user', 0, 1);
insert into PERSON (EMAIL, PASSWORDHASH, FIRSTNAME, LASTNAME, ROLE, ACTIVE) values ('mcfly.marty@bttf.com', 1216985755, 'Marty', 'McFly', 0, 1);
insert into PERSON (EMAIL, PASSWORDHASH, FIRSTNAME, LASTNAME, ROLE, ACTIVE) values ('dr.brown@bttf.com', 1216985755, 'Emmet', 'Brown', 0, 1);
insert into PERSON (EMAIL, PASSWORDHASH, FIRSTNAME, LASTNAME, ROLE, ACTIVE) values ('administrator@bookingoffice.com', 1216985755, 'Administrator', 'Person', 1, 1);
insert into PERSON (EMAIL, PASSWORDHASH, FIRSTNAME, LASTNAME, ROLE, ACTIVE) values ('accountant@bookingoffice.com', 1216985755, 'Accountant', 'Person', 2, 1);
insert into PERSON (EMAIL, PASSWORDHASH, FIRSTNAME, LASTNAME, ROLE, ACTIVE) values ('analyst@bookingoffice.com', 1216985755, 'Analyst', 'Person', 3, 1);

insert into ORDERING (BUYERID, PAYED, VALIDDATE) VALUES (3, 0, '2015-07-15');
